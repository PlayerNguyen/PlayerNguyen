  ...
  return (
    <section className="min-h-screen pt-20 pb-20 px-gutter bg-canvas flex items-center justify-center">
      <PageContainer>
        ...
        >
          <h1 className="text-display-xl text-primary font-mono mb-4">404</h1>
          <h2 className="text-display-md text-ink-strong mb-4">{t("not_found.title")}</h2>
          <p className="text-body-lg text-body mb-8">{t("not_found.message")}</p>
          <Link
            to="/"
